...
function createInstanceMatrixNode(builder, instanceMatrix, count) {
	...
	if (instanceMatrix.isStorageInstancedBufferAttribute === true) instanceMatrixNode = storage$1(instanceMatrix, "mat4", Math.max(count, 1)).element(instanceIndex$1);
...
*/
var instance$1 = /*@__PURE__*/ Fn$1(([count, matrices, colors = null], builder) => {
	count = count.value;
	...
	if (!isStorageMatrix) {
		if (count * 16 * 4 > builder.getUniformBufferLimit()) interleavedMatrix = _matrixBuffers.get(matrices);
	}
...
var instancedMesh$1 = /*@__PURE__*/ Fn$1(([instancedMesh]) => {
	...
	instance$1(count, instanceMatrix, instanceColor);
}, "void");
/**
...
TSL.emissive;
TSL.equal;
TSL.equirectDirection;
TSL.equirectUV;
TSL.exp;
TSL.exp2;
TSL.exponentialHeightFogFactor;
TSL.expression;
TSL.faceDirection;
TSL.faceForward;
TSL.faceforward;
...
TSL.transformNormal;
TSL.transformNormalByInverseViewMatrix;
TSL.transformNormalByViewMatrix;
...
TSL.viewZToReversedOrthographicDepth;
TSL.viewZToReversedPerspectiveDepth;
TSL.viewport;
TSL.viewportCoordinate;
TSL.viewportDepthTexture;
TSL.viewportLinearDepth;
TSL.viewportMipTexture;
TSL.viewportOpaqueMipTexture;
...
TSL.xor;
//#endregion
//#region node_modules/three/examples/jsm/tsl/math/curlNoise.js
/**
...
//#endregion
export { curlNoise, permute, snoise, snoiseVec3 };
